...
void main() {
  ...
  test('expone el punto de revisión autorizado', () {
    expect(catalog.reviewArea?.code, 'TEST');
    expect(catalog.reviewArea?.reviewLocation, const LatLng(-2.9, -79.0));
  });
}
