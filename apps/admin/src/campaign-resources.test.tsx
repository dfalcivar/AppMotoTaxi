...
it('explains four optional surfaces and three theme variants',()=>{
 ...
 for(const label of ['Imagen para Home','Imagen principal','Decoración de isla superior','Decoración adicional','General (ambos temas)','Claro opcional','Oscuro opcional','Vista aproximada de la isla'])expect(html).toContain(label);
