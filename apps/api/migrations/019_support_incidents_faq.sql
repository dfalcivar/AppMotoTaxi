...
INSERT INTO support_faqs (id, category, question, answer, sort_order) VALUES
  ...
  ('00000000-0000-0000-0000-000000001904','Seguridad','¿Cómo reporto un problema de seguridad?','Si existe peligro inmediato comunícate con los servicios de emergencia. En AtacamesGo crea un caso con prioridad crítica para que soporte lo atienda de forma prioritaria.',40),
