...
function adminError(error: unknown, reply: FastifyReply) {
  ...
  if (["PAYMENT_ALREADY_REVIEWED","PAYMENT_NOT_REFUNDABLE"].includes(message)) return reply.code(409).send({ error: message });
