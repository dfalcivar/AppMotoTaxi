...
Al aceptar un viaje, la API respeta primero la membresía pagada y la cortesía por días vigente. Si no hay cobertura de esas modalidades, utiliza un crédito de viaje gratis antes de cobrar el saldo Costa-Go. Una membresía por período mantiene los créditos programados hasta terminar; un paquete los mantiene programados hasta agotarse o vencer. La vigencia configurable de los créditos comienza con el primer viaje que usa la cortesía, cuando ya terminó la cobertura anterior. La migración 106 programa también los créditos ya activados que aún no se habían usado y cuyo conductor conserva una membresía vigente. La asignación conserva el total del pasajero y registra `BENEFIT_FREE_TRIP` con comisión aplicada de $0. El uso ocurre una sola vez al aceptar, incluso ante reintentos. Una cancelación del pasajero antes de iniciar devuelve el crédito; una cancelación del conductor después de aceptar lo conserva consumido, igual que el paquete por viajes. Al agotarse o vencer el crédito, se aplica la modalidad de cobro habitual. Suspensiones de cuenta, documentos y membresía siguen bloqueando al conductor.

`GET /v1/benefits/mine`, el historial administrativo y la respuesta de Membresía exponen `remainingTrips`. El beneficio programado informa sus días de vigencia sin inventar una fecha de vencimiento; Membresía indica si espera un paquete, una membresía por período o una cortesía por días. Pausar la definición impide nuevas activaciones sin quitar unidades ya acreditadas.
